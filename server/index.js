...
app.post("/detect/", upload.single("image"), async (req, res) => {
  try {
    ...
    const response = await axios.post("https://c8b8-110-54-174-189.ngrok-free.app/detect/", formData, {
...
app.post("/detect/upload", upload.single("image"), async (req, res) => {
  try {
    ...
    const response = await axios.post("https://c8b8-110-54-174-189.ngrok-free.app", formData, {
      headers: formData.getHeaders(),
    });
